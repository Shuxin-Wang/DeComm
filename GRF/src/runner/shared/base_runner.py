...
from src.utils.shared_buffer import SharedReplayBuffer
from src.algorithms.mat.mat_trainer import MATTrainer as TrainAlgo
...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        if self.algorithm_name in ["commnet", "decomm", "tarcomm", "gated_acml", "hygma"]:
            from src.algorithms.model.policy import CommunicationPolicy as Policy
        else:
            from src.algorithms.mat.algorithm.transformer_policy import TransformerPolicy as Policy
