...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='commformer', choices=["commformer", "commformer_dec", "commnet", "decomm", "tarcomm", "gated_acml", "hygma"])
    ...
    parser.add_argument("--comm_agents", type=int, default=0, help="during evaluation: randomly keep K agents for communication (0 disables)")
    parser.add_argument("--comm_select_by", type=str, default="reward", choices=["reward", "value", "random"], help="how to select communication agents when comm_agents > 0")
    ...
    parser.add_argument("--comm_init", type=str, default="uniform")
    ...
    parser.add_argument("--comm_action_one", action='store_true', default=True)
    ...
    parser.add_argument("--hygma_num_groups", type=int, default=2)
    parser.add_argument("--hygma_num_layers", type=int, default=2)
    return parser
