...
from src.envs.football.football_env import FootballEnv
from src.runner.shared.football_runner import FootballRunner as Runner
from src.envs.env_wrappers import ShareSubprocVecEnv, ShareDummyVecEnv
...
def main(args):
    ...
    elif all_args.algorithm_name in ["commformer", "commformer_dec", "commnet", "decomm", "tarcomm", "gated_acml", "hygma"]:
    ...
    if all_args.use_wandb:
        if wandb is None:
            raise ModuleNotFoundError("wandb is required when --use_wandb is set")
